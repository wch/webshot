...
The [**webshot**](https://github.com/wch/webshot) package makes it easy to take screenshots of web pages from R. It requires an installation of the external program [PhantomJS](http://phantomjs.org) (Windows users may use `webshot::install_phantomjs()` to install PhantomJS; OS X users may install it from Homebrew: `brew install phantomjs`).
