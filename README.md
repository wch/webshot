...
**Note:** webshot uses PhantomJS, which is a headless browser that
stopped development in 2018. Please use
[webshot2](https://github.com/rstudio/webshot2), which uses
